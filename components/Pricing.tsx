...
export const Pricing: React.FC<PricingProps> = ({ onSelectPlan, plans }) => {
  ...
  return (
    <div id="pricing-section" className="py-24 bg-dark-950 relative scroll-mt-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-xl mx-auto">Flexible subscription options for every creator.</p>
        </div>
          ...
          {plans.map((plan) => (
            ...
            >
              ...
              <div className="mb-8 p-4 rounded-xl bg-black/20 border border-white/5">
                <span className="block text-sm text-gray-400 mb-1">Monthly Credits</span>
                <span className="text-2xl font-bold text-indigo-400">{plan.credits}</span>
              </div>
